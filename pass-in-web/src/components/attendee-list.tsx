...
export function AttendeeList() {
  ...
  */
  ...
  function goToNextPage() {
    ...
    if (page * 10 >= attendees.length) { return; }
                ...
                <TableRow key={attendee.id} >
                  ...
                  <TableCell>
                    <div className="flex flex-col gap-2">
                      <span className="text-white">{formatDate(attendee.createdAt)}</span>
                      <span className="text-gray-400 text-sm">{formatDateDayjs(attendee.createdAt)}</span>
                    </div>
                  </TableCell>
            ...
            <TableCell className="text-right" colSpan={3}>
              ...
              <div className="inline-flex items-center gap-8">
                ...
                <div className="flex gap-1.5">
                  ...
                  <IconButton onClick={goToNextPage} disabled={page >= TOTAL_PAGE}>
                    <ChevronRight className="size-4" />
                  </IconButton>
                  <IconButton onClick={goToLastPage} disabled={page >= TOTAL_PAGE}>
